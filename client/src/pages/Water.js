...
const sendNotification = () => {
    ...
    const waterAdvice = [
        'Mild dehydration caused by exercise or heat has negative effects.',
        'Drinking more water may help with health problems, needed.',
        'Water can contribute to kidney stones'
    ];
